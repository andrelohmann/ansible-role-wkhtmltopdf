...
wkhtmltopdf is installed from the ubuntu distribution sources.
...
The default set of variables can be used to decide if the whole google fonts set needs to be installed
